...
pie showData
    title 2026-08-17 — 99 vulnerabilities
    "Critical" : 43
    "High" : 56
    "Medium" : 0
```
...
|--------|---------:|-----:|-------:|------:|
| cvefeed.io (High/Critical) | 43 | 56 | 0 | 99 |
...
| 9.6 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-71424 - Onyx: Cross-user OAuth-token leak via /api/mcp/servers* for per-user MCP servers](https://cvefeed.io/vuln/detail/CVE-2026-71424) | 1 hour, 17 minutes ago |
...
| 9.3 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-64849 - MLflow: Unauthenticated full-read SSRF in webhook delivery: _validate_webhook_url bypassed via unvalidated HTTP redirects (and DNS rebinding)](https://cvefeed.io/vuln/detail/CVE-2026-64849) | 1 hour, 17 minutes ago |
...
| 8.6 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-56677 - 9Router: Authenticated Server-Side Request Forgery (SSRF) via OIDC Provider Test Endpoint](https://cvefeed.io/vuln/detail/CVE-2026-56677) | 1 hour, 17 minutes ago |
...
| 8.0 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-45790 - Dokploy: Invitation Role Escalation Allows Organization Takeover](https://cvefeed.io/vuln/detail/CVE-2026-45790) | 1 hour, 17 minutes ago |
