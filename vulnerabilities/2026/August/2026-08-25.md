...
pie showData
    title 2026-08-25 — 150 vulnerabilities
    "Critical" : 43
    "High" : 107
    "Medium" : 0
```
...
|--------|---------:|-----:|-------:|------:|
| cvefeed.io (High/Critical) | 43 | 107 | 0 | 150 |

**KEV (actively exploited):** 0  **Watchlist matches:** 98
...
| 10.0 | — | cvefeed.io (High/Critical) | [CVE-2026-79911 - TOTOLINK N600R CGI cstecgi.cgi setSystemConfig stack-based overflow](https://cvefeed.io/vuln/detail/CVE-2026-79911) | 45 minutes ago |
...
| 9.8 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-80138 - ClipBucket V5 5.5.1 through 5.5.3-#153 OS Command Injection via Installer php_cli_filepath Parameter](https://cvefeed.io/vuln/detail/CVE-2026-80138) | 37 minutes ago |
...
| 9.3 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-80202 - Kimai before 2.56.0 Authorization Bypass via TimesheetVoter](https://cvefeed.io/vuln/detail/CVE-2026-80202) | 44 minutes ago |
...
| 9.1 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-62862 - TypeBot: Account takeover via brute-forceable 6-digit magic-link code](https://cvefeed.io/vuln/detail/CVE-2026-62862) | 32 minutes ago |
...
| 8.8 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-80193 - Kimai before 2.62.0 Authorization Bypass via QuickEntry](https://cvefeed.io/vuln/detail/CVE-2026-80193) | 44 minutes ago |
...
| 8.7 | — | cvefeed.io (High/Critical) | [CVE-2026-63403 - Faktory: Unrecovered panic in command handlers allows full-server denial of service](https://cvefeed.io/vuln/detail/CVE-2026-63403) | 32 minutes ago |
| 8.7 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-62865 - TypeBot: Arbitrary server file read via Send Email block attachment path](https://cvefeed.io/vuln/detail/CVE-2026-62865) | 32 minutes ago |
| 8.7 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-80198 - Kimai before 2.56.0 Information Disclosure via config() Twig Function](https://cvefeed.io/vuln/detail/CVE-2026-80198) | 44 minutes ago |
| 8.7 | — | cvefeed.io (High/Critical) | [CVE-2026-80197 - Kimai before 2.57.0 Improper Authorization via Favorite Endpoints](https://cvefeed.io/vuln/detail/CVE-2026-80197) | 44 minutes ago |
| 8.7 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-80196 - Kimai before 2.58.0 Authentication Bypass via Password Reset Link](https://cvefeed.io/vuln/detail/CVE-2026-80196) | 44 minutes ago |
| 8.7 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-80195 - Kimai before 2.63.0 Team Membership Removal via API](https://cvefeed.io/vuln/detail/CVE-2026-80195) | 44 minutes ago |
| 8.7 | — | cvefeed.io (High/Critical) | [CVE-2026-80194 - Kimai before 2.64.0 Missing Authorization via ProjectViewController export](https://cvefeed.io/vuln/detail/CVE-2026-80194) | 44 minutes ago |
| 8.7 | — | cvefeed.io (High/Critical) | [CVE-2026-80191 - GROWI before 8.0.2 Missing Authorization on Attachment Retrieval for Unauthenticated Requests](https://cvefeed.io/vuln/detail/CVE-2026-80191) | 44 minutes ago |
...
| 8.6 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-80192 - better-auth SSO before 1.6.27 Domain Ownership Authentication Bypass](https://cvefeed.io/vuln/detail/CVE-2026-80192) | 44 minutes ago |
...
| 8.3 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-79912 - TOTOLINK N600R cstecgi.cgi getCurrentTime command injection](https://cvefeed.io/vuln/detail/CVE-2026-79912) | 45 minutes ago |
