...
pie showData
    title 2026-09-04 — 102 vulnerabilities
    "Critical" : 37
    "High" : 65
    "Medium" : 0
```
...
|--------|---------:|-----:|-------:|------:|
| cvefeed.io (High/Critical) | 37 | 65 | 0 | 102 |
...
| CVSS | Flags | Source | CVE / Title | Reported |
|------|-------|--------|-------------|----------|
| 8.9 | — | cvefeed.io (High/Critical) | [CVE-2026-48019 - CRLF injection in Laravel's default email rule enables SMTP smuggling and spoofed-mail relay](https://cvefeed.io/vuln/detail/CVE-2026-48019) | 4 hours, 51 minutes ago |
...
| 8.7 | — | cvefeed.io (High/Critical) | [CVE-2026-46636 - Twig: Sandbox method allowlist bypass via `Markup` subclass](https://cvefeed.io/vuln/detail/CVE-2026-46636) | 5 hours, 50 minutes ago |
...
| 8.5 | — | cvefeed.io (High/Critical) | [CVE-2026-86095 - Unidata netcdf-c through 4.10.1 Out-of-bounds Write via Oversized HDF5 Attribute Name](https://cvefeed.io/vuln/detail/CVE-2026-86095) | 4 hours, 50 minutes ago |
...
| 8.3 | — | cvefeed.io (High/Critical) | [CVE-2026-86098 - ntop nDPI before 6.0 Heap Buffer Overflow via ndpi_json_string_escape](https://cvefeed.io/vuln/detail/CVE-2026-86098) | 4 hours, 50 minutes ago |
