...
pie showData
    title 2026-09-23 — 93 vulnerabilities
    "Critical" : 30
    "High" : 63
    "Medium" : 0
```
...
|--------|---------:|-----:|-------:|------:|
| cvefeed.io (High/Critical) | 30 | 63 | 0 | 93 |
...
| 9.9 | — | cvefeed.io (High/Critical) | [CVE-2026-84719 - Automation-controller: automation-controller: workflowjobtemplate /copy/ deep-copy sanitizer omits instance_groups authorization (instancegroup use_role bypass to control-plane)](https://cvefeed.io/vuln/detail/CVE-2026-84719) | 39 minutes ago |
| 9.9 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-84502 - Automation-controller: automation-controller-container: automation-controller: project scm_url argument injection into `git ls-remote --upload-pack` yields rce on the controller-task control-plane pod](https://cvefeed.io/vuln/detail/CVE-2026-84502) | 1 hour, 37 minutes ago |
...
| 9.8 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-93352 - Laravel-Mediable 7.0.0 < 7.0.2 RCE via .pht File Upload](https://cvefeed.io/vuln/detail/CVE-2026-93352) | 40 minutes ago |
| 9.8 | — | cvefeed.io (High/Critical) | [CVE-2026-6928 - Multiple Vulnerabilities in IBM Concert Software](https://cvefeed.io/vuln/detail/CVE-2026-6928) | 1 hour, 40 minutes ago |
| 9.8 | — | cvefeed.io (High/Critical) | [CVE-2026-6730 - Multiple Vulnerabilities in IBM Concert Software](https://cvefeed.io/vuln/detail/CVE-2026-6730) | 1 hour, 40 minutes ago |
| 9.8 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-6721 - Multiple Vulnerabilities in IBM Concert Software](https://cvefeed.io/vuln/detail/CVE-2026-6721) | 1 hour, 40 minutes ago |
...
| 9.4 | — | cvefeed.io (High/Critical) | [CVE-2026-87900 - WP Toolkit for cPanel Argument Injection](https://cvefeed.io/vuln/detail/CVE-2026-87900) | 39 minutes ago |
| 9.4 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-87899 - cPanel Arbitrary Code Execution via Privilege Escalation](https://cvefeed.io/vuln/detail/CVE-2026-87899) | 39 minutes ago |
| 9.4 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-87898 - Plesk OS Command Injection Vulnerability](https://cvefeed.io/vuln/detail/CVE-2026-87898) | 39 minutes ago |
...
| 9.3 | — | cvefeed.io (High/Critical) | [CVE-2026-96770 - s2s-proxy accepts untrusted client certificates](https://cvefeed.io/vuln/detail/CVE-2026-96770) | 1 hour, 37 minutes ago |
| 9.3 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-95601 - WordPress Product Filter by WBW plugin <= 3.1.7 - SQL Injection vulnerability](https://cvefeed.io/vuln/detail/CVE-2026-95601) | 1 hour, 37 minutes ago |
...
| 9.2 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-67404 - RabbitMQ: OAuth2 silent verify_none fallback for JWKS fetch](https://cvefeed.io/vuln/detail/CVE-2026-67404) | 1 hour, 40 minutes ago |
| 9.1 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-75884 - Awx: awx: privilege escalation to openshift namespace via pod_spec_override injection in container groups](https://cvefeed.io/vuln/detail/CVE-2026-75884) | 39 minutes ago |
| 9.1 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-67231 - RabbitMQ: Trust-store whitelist by Issuer+Serial only](https://cvefeed.io/vuln/detail/CVE-2026-67231) | 1 hour, 40 minutes ago |
...
| 8.8 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-70125 - Microsoft Outlook Remote Code Execution Vulnerability](https://cvefeed.io/vuln/detail/CVE-2026-70125) | 16 minutes ago |
| 8.8 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-86583 - Import and export users and customers <= 2.4.17 - Authenticated (Subscriber+) Privilege Escalation via CSV Escape-Character Mismatch in Export/Import Round Trip via display_name and nickname Profile Fields](https://cvefeed.io/vuln/detail/CVE-2026-86583) | 40 minutes ago |
| 8.8 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-81537 - DataStage on Cloud Pak for Data has several vulnerabilities](https://cvefeed.io/vuln/detail/CVE-2026-81537) | 40 minutes ago |
| 8.8 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-80423 - DataStage on Cloud Pak for Data has several vulnerabilities](https://cvefeed.io/vuln/detail/CVE-2026-80423) | 40 minutes ago |
| 8.8 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-80425 - DataStage on Cloud Pak for Data has several vulnerabilities](https://cvefeed.io/vuln/detail/CVE-2026-80425) | 1 hour, 40 minutes ago |
| 8.8 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-80412 - DataStage on Cloud Pak for Data has several vulnerabilities](https://cvefeed.io/vuln/detail/CVE-2026-80412) | 1 hour, 40 minutes ago |
| 8.8 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-80379 - DataStage on Cloud Pak for Data has several vulnerabilities](https://cvefeed.io/vuln/detail/CVE-2026-80379) | 1 hour, 40 minutes ago |
...
| 8.7 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-84691 - Automation-controller: automation-controller-container: automation-controller: format string injection in the api 4xx error log setting discloses django secret_key and database credentials to an administrator](https://cvefeed.io/vuln/detail/CVE-2026-84691) | 39 minutes ago |
| 8.7 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-84683 - Automation-controller: automation-controller-container: automation-controller: stored cross-site scripting in the job stdout html view via ansi osc 8 hyperlink sequences (javascript: anchor) enabling session takeover](https://cvefeed.io/vuln/detail/CVE-2026-84683) | 39 minutes ago |
| 8.7 | — | cvefeed.io (High/Critical) | [CVE-2026-82405 - Klever-Go Account takeover: `kleverUpdateAccountPermission` authorizes on attacker-controlled `RecipientAddr` instead of the authenticated caller](https://cvefeed.io/vuln/detail/CVE-2026-82405) | 39 minutes ago |
| 8.7 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-68492 - Plesk RESTful API Extension Untrusted Search Path Remote Code Execution Vulnerability](https://cvefeed.io/vuln/detail/CVE-2026-68492) | 39 minutes ago |
...
| 8.6 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-86064 - Klever-Go: /log controls global node logging](https://cvefeed.io/vuln/detail/CVE-2026-86064) | 39 minutes ago |
| 8.6 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-90904 - Joomla Extension - joomshaper.com - Broken Access Control (ACL Bypass) in ApiController Record Editing in Easy Store extension 1.0.0-3.0.0](https://cvefeed.io/vuln/detail/CVE-2026-90904) | 1 hour, 37 minutes ago |
| 8.6 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-90901 - Joomla Extension - joomshaper.com - Authenticated, Privileged SQL Injection in Media Image Deletion in Easy Store extension 1.0.0-3.0.0](https://cvefeed.io/vuln/detail/CVE-2026-90901) | 1 hour, 37 minutes ago |
| 8.6 | — | cvefeed.io (High/Critical) | [CVE-2026-82369 - Insufficient input sanitization of shell metacharacters in Brocade SANnav before 3.0.1a](https://cvefeed.io/vuln/detail/CVE-2026-82369) | 1 hour, 40 minutes ago |
| 8.5 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-94124 - WordPress WP EasyCart plugin <= 5.9.4 - SQL Injection vulnerability](https://cvefeed.io/vuln/detail/CVE-2026-94124) | 1 hour, 37 minutes ago |
| 8.5 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-93773 - WordPress Mollie Forms plugin <= 2.11.0 - SQL Injection vulnerability](https://cvefeed.io/vuln/detail/CVE-2026-93773) | 1 hour, 37 minutes ago |
| 8.5 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-93527 - WordPress Live Copy Paste for Elementor plugin <= 1.5.10 - SQL Injection vulnerability](https://cvefeed.io/vuln/detail/CVE-2026-93527) | 1 hour, 37 minutes ago |
...
| 8.4 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-82409 - Klever-Go: Elasticsearch bulk / painless injection via on-chain account name ->  explorer/indexer data forgery](https://cvefeed.io/vuln/detail/CVE-2026-82409) | 39 minutes ago |
...
| 8.2 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-68490 - CalDAV/CardDAV Improper Access Control](https://cvefeed.io/vuln/detail/CVE-2026-68490) | 39 minutes ago |
| 8.2 | — | cvefeed.io (High/Critical) | [CVE-2026-66079 - RabbitMQ: Pre-auth AMQP 1.0 array32 zero-width element DoS](https://cvefeed.io/vuln/detail/CVE-2026-66079) | 39 minutes ago |
| 8.2 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-90902 - Joomla Extension - joomshaper.com - Authenticated, Privileged SQL Injection in Coupon Bulk Update in Easy Store extension 1.0.0-3.0.0](https://cvefeed.io/vuln/detail/CVE-2026-90902) | 1 hour, 37 minutes ago |
| 8.2 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-90899 - Joomla Extension - joomshaper.com - Unauthenticated PII Exposure via IDOR in Guest Checkout in Easy Store extension 1.0.0-3.0.0](https://cvefeed.io/vuln/detail/CVE-2026-90899) | 1 hour, 37 minutes ago |
| 8.2 | — | cvefeed.io (High/Critical) | [CVE-2026-84486 - Automation-controller: automation-controller-container: automation-controller: unauthenticated debug scheduler-trigger endpoints (allowany, routed without debug guard) allow advisory-lock starvation of job dispatch (dos)](https://cvefeed.io/vuln/detail/CVE-2026-84486) | 1 hour, 37 minutes ago |
| 8.2 | — | cvefeed.io (High/Critical) | [CVE-2026-67232 - RabbitMQ: Web-MQTT decompression bomb](https://cvefeed.io/vuln/detail/CVE-2026-67232) | 1 hour, 40 minutes ago |
...
| 8.1 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-94487 - WordPress PublishPress Capabilities plugin <= 2.50.1 - Cross Site Request Forgery (CSRF) vulnerability](https://cvefeed.io/vuln/detail/CVE-2026-94487) | 1 hour, 37 minutes ago |
| 8.1 | ⭐ | cvefeed.io (High/Critical) | [CVE-2026-19125 - EthPress <= 2.3.5 - Unauthenticated Authentication Bypass](https://cvefeed.io/vuln/detail/CVE-2026-19125) | 40 minutes ago |
